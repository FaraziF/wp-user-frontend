Feature('Customer Buy Subscription Pack Using Stripe Gateway');
...
Scenario('Create Subscription Pack And SetUp Paymeny Gateway', (I) => {
    ...
    I.click('Subscriptions');
        ...
        I.fillField('Pack Name','Super Pack 2');
        // I.fillField('//body[contains(.,"pack description")]', 'Description DescriptionDescription');
        //Payment Settings 
    ...
    // I.click('Settings');
        I.click('Payments');
            ...
            I.fillField('wpuf_payment[stripe_api_secret]','farazi');
            I.fillField('wpuf_payment[stripe_api_key]','farazi');
